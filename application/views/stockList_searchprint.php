...
<h3 class="center">ကုန္က်န္စာရင္းမ်ား</h3>
<table class="table">
			<thead>
				<tr>
					<th>စဥ္</th>
					...
					<th>အမည္</th>
					<th style="width:20%;">လိပ္စာ</th>
					<th class="align-right">ေခ်းေငြ (က်ပ္)</th>
					<th class="align-right">ပစၥည္း</th>
			...
			<tbody id="content">
                ...
                <tr>
					...
					<td class="center"><?php echo $row->voucher; ?></td>	
