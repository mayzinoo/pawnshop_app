...
<h3 class="center">အထုပ္ လခ်ဳပ္စာရင္း</h3>
<div class="row mt">
          <div class="col-md-12">
            ...
            <tbody id="content">
                  <tr>
                    <td style="background:#CD232C;">ေခ်းေငြ</td>
                     ...
                     ?>
                         <td><?php echo $totalamt->ctotal; ?></td>
                     <?php endforeach; ?>
       ...
       <td>
                   ...
                   echo" </td>";
                    ...
                    $spdata=$this->Main_model->cget_byspecificdata($vdate,$collist->vr_type);
                    if($spdata->loantotal=="0"){
                      echo "<td>";
                      echo "";
                      echo "</td>";
                    }
              ...
              <tr>
                  <td>ေရြးေငြေပါင္း</td>
                              ...
                              echo" </td>";
                                 foreach($collateraldata->result() as $collist):
                                     $vdate= $rdate->ydate."-".$rdate->mdate;
                                     $spdata=$this->Main_model->cget_byspecifirdata($collist->vr_type);
                                     echo "<td>";
                                     echo $spdata->loantotal;
                                     echo "</td>";
             ...
             <tr>
               <td>က်န္ေငြ</td>
                       ...
                       echo" </td>";
                          foreach($collateraldata->result() as $collist):
                              $vdate= $rdate->ydate."-".$rdate->mdate;
                              $spdata=$this->Main_model->cget_byspecifiremaindata($collist->vr_type);
                              $result=$spdata->remaintotal;
                              if($result=='0'){
                                echo "<td>";
                                echo "";
                                echo "</td>";
